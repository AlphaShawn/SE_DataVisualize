...
<body>
	...
	<div id = "content">
		...
		<div class="row" style="margin:0;float:none;">
	...
	<div class="jumbotron" style="padding-bottom:0px;margin-bottom:0px;">
		<div class="container">
			<h2>Note:</h2>
			<p>
				&nbsp &nbsp &nbsp &nbsp 数据来源：电院综测网站抓取并处理得到（z.seiee.com）<br/>
	...
	<div class="jumbotron" >
		<div class="container">
			<h2>Analyse</h2>
			<p>
				&nbsp &nbsp &nbsp &nbsp 将素拓成绩分段，对各段的各项素拓数据取平均值得下图。由图可知，数据在不同区间段有不一样的变化幅度。据此进行推测并做进一步分析。
			</p>
			<img src="/alpha/image/quality-all.png" class="img-thumbnail center-block" style="margin-top:15px;margin-bottom:50px;"/>
			<p>
				&nbsp &nbsp &nbsp &nbsp 取素拓成绩分段作为X轴，做硬加分与纯素拓的折线图。发现，同为素拓总分的组成部分，纯素拓在总分较低时变化较快，而硬加分在总分较高时，变化幅度较大。<br/>
			...
			<p>
				&nbsp &nbsp &nbsp &nbsp 参与活动数随着素拓总分下降呈线性下降。<br/>
			...
			<p>
				...
				<span class="text-right" style="display:block; font-size:14px">(计算方式：Excel内CORREL函数，越接近1越相关)</span>
				&nbsp &nbsp &nbsp &nbsp 结论：纯素拓在总分20-28区间下主要由参与活动数决定。<br/>
			</p>	
			<div class="row" style="margin-bottom:50px;">
				<div class="col-md-6">
